              ...
              <div className="contact-content-part  wow fadeInUp delay-0-2s">
                ...
                <div className="single-contact wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <div className="about-social">
                    <ul>
                      <li>
                        <a target='_blank' href="https://www.linkedin.com/in/absk-tiwari1901/"><i className="ri-linkedin-fill"></i></a>
                      </li>
                      <li>
                        <a target='_blank' href="https://github.com/Absk-tiwari"><i className="ri-github-line"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
